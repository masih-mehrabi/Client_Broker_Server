...
import client_broker_server.server.Server;
...
public class Broker {
	...
	public Service getService(String serviceName) {
		return switch (serviceName) {
			...
			case TranslationService.SERVICE_NAME_TRANSLATION_GERMAN, TranslationService.SERVICE_NAME_TRANSLATION_FRENCH -> new TranslationClientSideProxy(this);
			default -> null;
		};
	}
